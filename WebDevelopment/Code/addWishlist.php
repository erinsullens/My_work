...
<h2>Wine Collection - Add to Wishlist</h2>
    <?php
  ...
  require_once('connect.php');
   ...
   $query = "INSERT INTO wineWishlist (winery, wineType, vintage, wineColor, notes, price, memberId) VALUES ('$winery', '$wineType', '$vintage', '$wineColor', '$notes', '$price', '$mId')";
