...
<h2>Wine Collection - View Collection</h2>
    <?php
...
$query = "SELECT winery, wineType, vintage, notes, datePurchased, wineColor FROM wine WHERE memberId = '$mId'";
...
if($response){
    ...
    <td align="left"><b>Date Purchased</b></td>
        ...
        <td align="left"><b>Wine Color</b></td></tr>';
    ...
    while($row = mysqli_fetch_array($response)){
        ...
        $row['datePurchased'] . '</td><td align="left">' .
